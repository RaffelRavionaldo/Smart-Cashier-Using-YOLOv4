...
class yoloRotatebbox:
    ...
    def rotate_image(self):
        ...
        bound_w = int(width * 0.8)
        bound_h = int(height * 0.8) # semakin gede angka, semakin ke zoom out
...
if __name__ == "__main__":
    ...
    for angle in sudut:
        ...
        for file in glob.glob("*.jpg"):
            ...
            cv2.imwrite(os.path.join(r"F:\zoom in", 'zoom_in'+ image_name +'_' + str(angle) + '.jpg'), image)

            file_name = os.path.join(r"F:\zoom in",'zoom_in'+image_name+'_' + str(angle) + '.txt')
